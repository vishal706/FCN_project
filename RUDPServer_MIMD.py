...
#  python3 RUDPServer_MIMD.py -i "10.0.0.2" -p 106 -f "recv.txt"
...
Rudp_MIMD = RUDP_server_MIMD(options.port, options.segmentSize, options.bufferSize)

start = timer()
Rudp_MIMD.createConnection()
...
Rudp_MIMD.ReceiveData(file_location)
end = timer()
